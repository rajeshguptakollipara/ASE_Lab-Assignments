...
public class UserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		MongoClientURI uri = new MongoClientURI("mongodb://nareshgo"
				+ ""
				+ "ud:ase123@ds011268.mlab.com:11268/asecarpool");
		MongoClient client = new MongoClient(uri);

		DB db = client.getDB(uri.getDatabase());
		DBCollection users = db.getCollection("users");
		BasicDBObject query = new BasicDBObject();
		query.put("name",request.getParameter("name"));// request.getParameter("name"));
		query.put("password",request.getParameter("password")); //request.getParameter("password"));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MongoClientURI uri = new MongoClientURI("mongodb://nareshgoud:ase123@ds011268.mlab.com:11268/asecarpool");
		MongoClient client = new MongoClient(uri);
